...
//include "funciones.php"; Lo usamos solo para chequear que estamos trayendo correctamente el archivo de funciones.

$errores = [];
$nameOk = "";
//var_dump($_POST); // Para chequear qué estamos mandando dentro de la variable. También podemos usar var_dump dentro de la función validarRegistro() para ver como lo recibe.

if($_POST){
    $errores = validarRegistro($_POST);

    $nameOk = trim($_POST["name"]); //Chequear lógica.

    if(empty($errores)){
        // más adelante veremos que pasos hay que incluir cuando ya no tengamos errores de validación.
    }
